...
public class WarehouseController{
     ...
     */
    public void addSellableProduct(String barcode, String description, double price, int amount, int minAmount, int maxAmount, boolean unique)
    {
        SellableProduct newProduct = new SellableProduct(barcode, description, price, amount, minAmount, maxAmount, unique);
     ...
     * @return boolean
     */
    public boolean addRentableProduct(String barcode, int productID, String description, double price, String placement, String physicalDescription)
    {
        RentableProduct newProduct = new RentableProduct(barcode, productID, description, price, placement, physicalDescription);
    ...
    public void transfer(int input)
    {
        ...
        {   
            ...
            if(tempProduct != null)
            {
                tempProduct.setAmountSellableProduct((tempProduct.getAmountSellableProduct()+tempTransferlist.getAmount(info.get(i))));
            }
            else
            {
